...
const features = [
  {
    ...
    description: "Nous remettons a plat vos flux et vos sources pour construire une base de donnees fiable, exploitable et durable.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Automatisation par l'IA",
    description: "Nous automatisons les taches repetitives et accelerons les operations metier avec des workflows IA utiles au quotidien.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Outils digitaux sur mesure",
    description: "Sites web, dashboards, CRM et applications internes concus pour vos equipes, vos objectifs et vos contraintes.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Pilotage de la performance",
    description: "Nous transformons des systemes complexes en indicateurs clairs pour ameliorer la prise de decision.",
    visual: "security",
  },
];
    ...
    >
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-16 py-10 lg:py-20 border-b border-foreground/10">
        ...
        <div className="shrink-0 flex lg:block items-center gap-3">
          ...
          {/* Visual visible on mobile/tablet beside number */}
          <div className="lg:hidden w-10 h-8 text-foreground/40 ml-auto">
        ...
        <div className="flex-1 grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
          <div>
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-display mb-3 lg:mb-4 group-hover:translate-x-2 transition-transform duration-500">
              {feature.title}
            </h3>
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-12 lg:mb-24">
          ...
          >
            Votre croissance,
            <br />
            <span className="text-muted-foreground">alimentee par la data.</span>
          </h2>
        </div>
