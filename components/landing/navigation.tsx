...
const navLinks = [
  { name: "Expertises", href: "#features" },
  { name: "Methode", href: "#how-it-works" },
  { name: "Resultats", href: "#studio" },
  { name: "Engagements", href: "#security" },
...
export function Navigation() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl" : "text-2xl"}`}>DataForge</span>
            <span className={`text-muted-foreground font-mono transition-all duration-500 ${isScrolled ? "text-[10px] mt-0.5" : "text-xs mt-1"}`}>IA</span>
          </a>
      ...
      >
        <div className="flex flex-col h-full px-8 pt-24 pb-10 safe-bottom">
          {/* Navigation Links */}
